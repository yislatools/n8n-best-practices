...
**Repository Classification**: L1_OFFICIAL_COMPONENTS  
**Neural Weight**: 0.90  
**Dependency Level**: Low (depends on core)  
**Ecosystem Position**: Official documentation hub  

**Connected Repositories**:
- Documents: n8n-core, n8n-nodes-base
- Integrates with: n8n-template-workflows
- Depends on: n8n-core
...
- SSH integration for org members
